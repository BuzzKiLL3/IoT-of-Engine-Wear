...
#define SSID "BuzzKiLL2G" // "SSID-WiFiname"
#define PASS "ombadagi" // "password"
#define IP "184.106.153.149"// thingspeak.com ip
String msg = "GET https://api.thingspeak.com/update?api_key=SH553CH5F3DIHZU7&field1=0"; //change it with your api key
...
volatile int IBI = 6; // int that holds the time interval between beats! Must be seeded!
